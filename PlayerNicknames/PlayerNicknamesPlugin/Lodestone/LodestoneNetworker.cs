...
using PlayerNicknames.PlayerNicknamesPlugin.Lodestone.Lodestone;
...
namespace PlayerNicknames.PlayerNicknamesPlugin.Lodestone;
...
internal class LodestoneNetworker : ILodestoneNetworker, IDisposable
{
    ...
    public ILodestoneQueueElement SearchCharacter(INameDatabaseEntry entry, Action<INameDatabaseEntry, LodestoneSearchData> success, Action<Exception> failure)
    {
